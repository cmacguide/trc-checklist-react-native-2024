	...
	return (
		<ScrollView style={styles.container}>
					...
					>
						<Text>{item.itens_nome} </Text>
						{
							<SelectDropdown
								...
								onSelect={(selectedItem) => {
									WizardStore.update((s) => {
										s.step["step_" + currentStep + "_criticidade"][index] =
											selectedItem;
										//s.step[currentStep]["criticidade"][index]=selectedItem
										s.grupo_checklist[currentStep][index].criticidade =
											selectedItem;
										console.log(
											"s",
											s,
...

						{
							<SelectDropdown
								...
								onSelect={(selectedItem) => {
									WizardStore.update((s) => {
										s.step["step_" + currentStep + "_conformidade"][index] =
											selectedItem;
										s.grupo_checklist[currentStep][index].conformidade =
											selectedItem;
			...
			<Button
				...
				onPress={handleSubmit(onSubmitBack)}
			>
				VOLTAR ({currentStep})
			</Button>
			<Button
